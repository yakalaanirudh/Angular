...
export class CoursesComponent{
  ...
  getTotalCourses(){    //Returns number of total courses
    return this.courses.length;
  }
  getTotalFreeCourses(){    //Returns number of free courses
    return this.courses.filter(course => course.type === 'Free').length;
  }
  getTotalPremiumCourses(){   //Returns number of premium courses
